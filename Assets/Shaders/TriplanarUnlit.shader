        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                o.worldPos = v.vertex.xyz;// mul(unity_ObjectToWorld, float4(v.vertex.xyz, 1)).xyz;
                o.worldNormal = v.normal;// normalize(UnityObjectToWorldNormal(v.normal));
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float3 albedo = UNITY_ACCESS_INSTANCED_PROP(PerInstance, col).rgb;

                float3 diffuseLight = saturate(dot(worldNormal, float3(0, 1, 0)));
